...
export class PersistentStorage {
    constructor(dataPath) {
        ...
        if (!dataPath) {
            console.error(`⚠️  Storage path not provided. Using default path: ${this.storageFile}`);
            console.error("⚠️  NOTE: If this path is not accessible, storage will be ephemeral (in-memory only)");
        }
    }
